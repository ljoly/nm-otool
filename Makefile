...
#    Updated: 2018/12/11 19:58:40 by ljoly            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = ft_nm

SRC = main.c handle_arg.c error.c handle_magic.c handle_64.c get_sections_64.c \
		...
		handle_fat_64.c handle_arch.c handle_32.c get_sections_32.c
